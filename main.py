    ...
    try:
        ...
        if eth.protocol == "IPv4":
            ...
            if ip.protocol == "TCP":
                ...
                print(f" {ip.src_addr} >> {ip.dst_addr}   TCP  {tcp.src_port} >> {tcp.dst_port}  ACK: {tcp.ack}   seq: {tcp.seq_num}")
        ...
        #ipv6===============================================================================================================  
            ...
            if ipv6.protocol == "TCP":
                tcp = TCP(data[54:])
                print(curent_time, end=" ")
                print(f" {ipv6.src}  >>  {ipv6.dst}  TCP  {tcp.src_port} >> {tcp.dst_port}  ACK: {tcp.ack}  seq: {tcp.seq_num}")
